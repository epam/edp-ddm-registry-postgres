...
export redashViewerRoleName="redash_viewer_role"
export redashViewerRolePass="redash_viewer_role"
export redashAdminRoleName="redash_admin_role"
export redashAdminRolePass="redash_admin_role"
#DB
